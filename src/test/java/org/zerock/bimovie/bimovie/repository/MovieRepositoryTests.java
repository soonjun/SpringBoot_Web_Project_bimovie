package org.zerock.bimovie.bimovie.repository;
...
import org.zerock.bimovie.bimovie.entity.Movie;
import org.zerock.bimovie.bimovie.entity.Poster;
...
public class MovieRepositoryTests {
    ...
    public void testInsert() {
        ...
        movie.addPoster(Poster.builder().fname("극한직업포스터1.jps").build());
        movie.addPoster(Poster.builder().fname("극한직업포스터2.jps").build());
    ...
    public void insertMovies() {
        ...
        IntStream.rangeClosed(10,100).forEach(i->{
            ...
            movie.addPoster(Poster.builder().fname("세계명작"+i+"포스트2.jpg").build());
